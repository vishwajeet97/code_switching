...
def inference_graph():
	...
	with tf.variable_scope("rnn") as vs:
		for i in range(num_steps):
			...
			min_index_state_0 = tf.stack([idx, tf.nn.top_k(entropy, k=2)[1][:,0]], axis=1)
			min_index_state_1 = tf.stack([idx, tf.nn.top_k(entropy, k=2)[1][:,1]], axis=1)
...
if __name__ == '__main__':
	...
	index1 = []
	index2 = []
	model_init_path = "/home/vishwajeet/exp/src/models/cond-rnn_model-4-beamsearch.ckpt"
